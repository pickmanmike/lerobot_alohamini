...
git merge-base --is-ancestor 9f61246285bc7af778862da4a36f8d07098a2a34 HEAD
if ($LASTEXITCODE -ne 0) { throw 'The reviewed Windows AR1 code commit is not present.' }
$reviewedTail = @(git diff --name-only 9f61246285bc7af778862da4a36f8d07098a2a34..HEAD)
