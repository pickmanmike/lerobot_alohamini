...
git merge-base --is-ancestor 0b39b2208b9d7d1d4961fbbb31bd925d8d84fde7 HEAD
if ($LASTEXITCODE -ne 0) { throw 'The reviewed Windows AR1 code commit is not present.' }
$reviewedTail = @(git diff --name-only 0b39b2208b9d7d1d4961fbbb31bd925d8d84fde7..HEAD)
